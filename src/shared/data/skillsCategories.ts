export const skillsCategories = [
	{
		...
		skills: [
			...
			{ id: 109, name: 'Бизнес-план' },
		],
	},
	{
		id: 2,
		name: 'Творчество и искусство',
		icon: 'C:src/shared/assets/icons/palette.svg',
		color: '#FF69B4',
		skills: [
			...
			{ id: 209, name: 'Игра на барабанах' },
		],
	},
	{
		id: 3,
		name: 'Иностранные языки',
		icon: 'C:src/shared/assets/icons/global.svg',
		color: '#87CEEB',
		skills: [
			{ id: 301, name: 'Английский язык' },
			{ id: 302, name: 'Испанский' },
